...
<div align="justify">
	<p>Total Price : ${total} Rupees
	<p>Please provide your Credit/Debit Card Details
</div>
<div align="justify">
	<form id="form1" name="form1" method="post"
		action="cartStore.jsp?page=orderConfirmation">
		<table width="494" height="172" border="0">
			...
			<tr>
				<td>CVV</td>
				<td><label for="cvv"></label> <input type="password"
					name="cvv2" id="cvv" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="submit" name="submit" id="submit"
					value="Submit" />&nbsp; <input type="reset" name="clear"
					id="clear" value="Reset" />&nbsp;</td>
			</tr>
		</table>
	</form>
</div>
